...
@Component({
  selector: 'app-minimap-phase4',
  templateUrl: './minimap-phase4.component.html',
  styleUrls: ['./minimap-phase4.component.scss']
})
export class MinimapPhase4Component {
  ...
  updateZone() {
    ...
    this.minimapPhase2Canvas.nativeElement.style.background = `url( ../../../../../assets/RiseAssets/mapRiseGOOD.png)`;
