...
@Component({
  selector: 'app-minimap-phase3',
  templateUrl: './minimap-phase3.component.html',
  styleUrls: ['./minimap-phase3.component.scss']
})
export class MinimapPhase3Component {
  ...
  updateZone() {
    ...
    this.minimapPhase2Canvas.nativeElement.style.background = `url( ../../../../../assets/DepressionAsset/mapDepressionGOOD.png)`;
